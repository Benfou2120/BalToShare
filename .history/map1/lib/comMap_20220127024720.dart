...
class popInfo extends StatelessWidget {
  ...
  List<Box> listbox = [ 
    Box("boite 1", "3 rue des arts", "Pour tous",image),
    Box("boite 2", "13 bis rue du manoir", "Pour tous"),
    Box("boite 3", "3355 boul des Forges", "Pour Canadien"),
  ];
                ...
                margin: EdgeInsets.fromLTRB(20, 250, 20, 250),
                  ...
                  child: Padding(
                    ...
                    child: ListView(
                          ...
                          children: [
                            BoxCard(tit: "boite 1", access: "Pour tous",adress: "3 rue des Arts", image: imageB1,),
                            const Divider(     
                              color: Colors.white,
                              thickness: 0.2,
                            ),
...
class BoxCard extends StatelessWidget {
  BoxCard({required this.tit, required this.adress, required this.access, required this.image});
